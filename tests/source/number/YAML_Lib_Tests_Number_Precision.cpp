...
// =====================================
TEST_CASE("Check JNode Number floating point precision.", "[YAML][JNode][Number][Float][Precision]")
{
    const YAML yaml;
    SECTION("Floating point precision to 6 (default).", "[YAML][JNode][Number][Float][Precision]")
    {
    ...
    SECTION("Floating point precision to 7.", "[YAML][JNode][Number][Float][Precision]")
    {
        std::string expected{ R"({"latitude":39.068341,"longitude":-70.741615})" };
        BufferSource yamlSource{ expected };
        yaml.parse(yamlSource);
    ...
    SECTION("Floating point precision to 8.", "[YAML][JNode][Number][Float][Precision]")
    {
        std::string expected{ R"({"latitude":39.068341,"longitude":-70.741615})" };
        BufferSource yamlSource{ expected };
        yaml.parse(yamlSource);
    ...
    //   SECTION("Floating point precision to maximum.", "[YAML][JNode][Number][Float][Precision]")
    //   {
    //     std::string expected{ R"({"latitude":39.068341,"longitude":-70.741615})" };
    //     BufferSource yamlSource{ expected };
    //     yaml.parse(yamlSource);
    ...
    //       REQUIRE(yamlDestination.toString() == R"({"latitude":39.06834030151367,"longitude":-70.74161529541016})");
    //     } else if constexpr (std::numeric_limits<long double>::digits10 + 1 == 19) {
    //       REQUIRE(yamlDestination.toString() == R"({"latitude":39.06834030151367188,"longitude":-70.74161529541015625})");
    //     } else {
    //       REQUIRE_FALSE(true);
    //     }
    //   }
