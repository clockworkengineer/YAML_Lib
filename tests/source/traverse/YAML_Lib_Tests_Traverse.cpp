...
public:
  ...
  virtual void onYNode([[maybe_unused]] const YNode &yNode) override {
    totalNodes++;
  }
  // Add string details to analysis
  virtual void onString([[maybe_unused]] const YNode &yNode) override {
    totalStrings++;
  }
  ...
  virtual void onBoolean([[maybe_unused]] const YNode &yNode) override {
    totalBoolean++;
  }
  // Add null details to analysis
  virtual void onNull([[maybe_unused]] const YNode &yNode) override {
    totalNull++;
  }
  // Add array details to analysis
  virtual void onArray([[maybe_unused]] const YNode &yNode) override {
    totalArrays++;
  }
  // Add object details to analysis
  virtual void onDictionary([[maybe_unused]] const YNode &yNode) override {
    totalDictionarys++;
  }
