...
class YAML_Analyzer final : public IAction {
 public:
  ...
  void onBoolean([[maybe_unused]] const Node& yNode) override { totalBoolean++; }
  ...
  void onDictionary([[maybe_unused]] const Node& yNode) override { totalDictionaries++; }
...
TEST_CASE("YAML Node tree traverse tests ", "[YAML][Traverse]") {
  ...
  SECTION(
      "Parse a object({\"one\" : 1, \"two\" : 2, \"three\" : 3 })) and "
      "traverse",
  ...
  SECTION(
      "Parse a nested object ([true,\"Out of "
