...
TEST_CASE("YAML test-suite — programmatic sweep of all suite files (gap 3.8).",
  ...
  static const std::unordered_set<std::string> knownFailures{
      ...
      "DC7X",   "DK95/0", "DK95/1", "DK95/4", "DK95/5", "F2C7",   "FH7J",
      "G5U8",   "GDY7",   "H7TQ",   "HMQ5",   "HRE5",   "J3BT",   "JKF3",
      "JTV5",   "JY7Z",   "K3WX",   "KH5V/1", "KK5P",   "LHL4",   "LP6E",
      "MUS6/0", "MUS6/6", "NKF9",   "NP9H",   "P76L",   "Q4CL",   "Q8AD",
