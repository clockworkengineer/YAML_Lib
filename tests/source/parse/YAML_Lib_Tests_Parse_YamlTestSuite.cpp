...
TEST_CASE("YAML test-suite — programmatic sweep of all suite files (gap 3.8).",
  ...
  static const std::unordered_set<std::string> knownFailures{
      "7BMT", "7FWL", "7LBH", "7TMG", "7W2P", "7ZZ5", "8UDB", "8XDJ", "9C9N",
      "9JBA", "9KBC", "9MMA", "9MMW", "AVM7", "AZ63", "B63P", "BF9H", "CN3R",
      "CQ3W", "CT4Q", "CVW2", "CXX2", "D49Q", "DC7X", "F2C7", "FH7J", "G5U8",
      "GDY7", "H7TQ", "HMQ5", "HRE5", "J3BT", "JKF3", "JTV5", "JY7Z", "K3WX",
      "KK5P", "LHL4", "LP6E", "NKF9", "NP9H", "P76L", "Q4CL", "Q8AD", "QB6E",
      "QF4Y", "QLJ7", "RLU9", "RXY3", "RZP5", "SR86", "SU5Z", "SU74", "SY6V",
  };
