...
TEST_CASE("Check YAML Parsing of simple scalar types.",
  ...
  // SECTION("YAML parse a string block.", "[YAML][Parse][Scalar][String]") {
  ...
  // }
  // SECTION("YAML parse a piped string block.",
  // "[YAML][Parse][Scalar][String]") {
  //   BufferSource source{"---\nbar: |\n  this is not a normal string it\n  "
  //                       "spans more than\n  one line\n  see?\n"};
  //   REQUIRE_NOTHROW(yaml.parse(source));
  ...
  // }
  // SECTION(
  //     "YAML parse a piped string block that is terminated to key value
  //     pair.",
  //     "[YAML][Parse][Scalar][String]") {
  //   BufferSource source{"---\nbar: |\n  this is not a normal string it\n  "
  //                       "spans more than\n  one line\n  see?\nfoo: True\n"};
  ...
  //                       "IParser Error: Invalid key 'see?' specified.");
  // }
  // SECTION("YAML parse a plain string block.",
  // "[YAML][Parse][Scalar][String]") {
  //   BufferSource source{
  //       "---\n  Mark McGwire\'s\n  year was crippled\n  by a knee injury."};
  //   REQUIRE_NOTHROW(yaml.parse(source));
  ...
  // }
  //   SECTION("YAML parse regular string multiline.",
