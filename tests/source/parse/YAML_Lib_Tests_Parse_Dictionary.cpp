...
TEST_CASE("Check YAML Parsing of Dictionary's.", "[YAML][Parse][Dictionary]") {
  const YAML yaml;
  SECTION("YAML parse dictionary with one key value pair.", "[YAML][Parse][Dictionary]") {
  ...
  SECTION("YAML parse dictionary with two key value pair.", "[YAML][Parse][Dictionary]") {
  ...
  SECTION("YAML parse dictionary with three key value pair and validate.",
    ...
    REQUIRE(NRef<Number>(NRef<Dictionary>(yaml.document(0))["pi"]).value<int>() ==
            3);  // check as int to save rounding errors
  }
  SECTION(
      "YAML parse dictionary with one key value pair and the value is an "
  ...
  SECTION(
    ...
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)).contains("doe"));
    REQUIRE(NRef<String>(yaml.document(0)["doe"]).value() == "a deer, a female deer");
  }
  SECTION("YAML parse dictionary with two key value pair with one nested.",
    ...
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["outer"]).contains("inner"));
  ...
  SECTION("YAML parse dictionary with three key value pair with one nested.",
    ...
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["outerone"]).contains("innerone"));
    REQUIRE(NRef<String>(yaml.document(0)["outerone"]["innerone"]).value() == "true");
  ...
  SECTION(
      "YAML parse dictionary with key value pair and inline dictionary on "
      "the different lines.",
      "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n outer: \n { inner: 'true'}\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
  ...
  SECTION("Parse Dictionary from file and verify.", "[YAML][Parse][Examples][File]") {
    ...
    REQUIRE(NRef<String>(yaml.document(0)["calling-birds"][0]).value() == "huey");
    REQUIRE(NRef<String>(yaml.document(0)["calling-birds"][1]).value() == "dewey");
    REQUIRE(NRef<String>(yaml.document(0)["calling-birds"][2]).value() == "louie");
    REQUIRE(NRef<String>(yaml.document(0)["calling-birds"][3]).value() == "fred");
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)).contains("xmas-fifth-day"));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)["xmas-fifth-day"]));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["xmas-fifth-day"]).contains("calling-birds"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["xmas-fifth-day"]).contains("french-hens"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["xmas-fifth-day"]).contains("golden-rings"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["xmas-fifth-day"]).contains("partridges"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["xmas-fifth-day"]).contains("turtle-doves"));
    REQUIRE(NRef<String>(yaml.document(0)["xmas-fifth-day"]["calling-birds"]).value() == "four");
    REQUIRE(NRef<Number>(yaml.document(0)["xmas-fifth-day"]["french-hens"]).value<int>() == 3);
    REQUIRE(NRef<Number>(yaml.document(0)["xmas-fifth-day"]["golden-rings"]).value<int>() == 5);
    REQUIRE(NRef<String>(yaml.document(0)["xmas-fifth-day"]["turtle-doves"]).value() == "two");
    REQUIRE(NRef<Number>(yaml.document(0)["xmas-fifth-day"]["partridges"]["count"]).value<int>() ==
            1);
    REQUIRE(NRef<String>(yaml.document(0)["xmas-fifth-day"]["partridges"]["location"]).value() ==
            "a pear tree");
#endif  // YAML_LIB_FILE_IO
  }

  SECTION("YAML parse flat dictionary of integers and verify.", "[YAML][Parse][Dictionary]") {
    ...
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["foo"]).contains("thing1"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["foo"]).contains("thing2"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["foo"]).contains("thing3"));
  ...
  SECTION("YAML parse flat dictionary of quoted strings and verify.", "[YAML][Parse][Dictionary]") {
  ...
  SECTION("YAML parse dictionary with space in key name.", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\nMark McGwire: 55\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
  ...
  SECTION("YAML parse dictionary with duplicate keys.", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\nthing1: \"one\"\nthing1: \"two\"\nthing3: \"three\"\n"};
    REQUIRE_THROWS_WITH(yaml.parse(source),
  ...
  SECTION(
      "YAML parse dictionary with duplicate keys in two "
  ...
  SECTION("YAML parse dictionary with non string keys (boolean).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\ntrue: true\nfalse: false\n..."};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
  ...
  SECTION("YAML parse dictionary with non string key (null).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\nnull: 1\n..."};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
  ...
  SECTION("YAML parse dictionary with non string key (number).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n666: 1\n..."};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
  ...
  SECTION(
      "YAML parse dictionary with non string keys (nested inline "
      "dictionary 1).",
      "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n{one: 1, { three: 3} }: 'test'\n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
  ...
  SECTION("YAML parse dictionary with non string keys (nested inline dictionary).",
          "[YAML][Parse][Dictionary]") {
  ...
  SECTION(
      "YAML parse inline dictionary on more than line. "
      "(inline dictionary).",
      "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n{ one: \n1, \n two : 2\n, \n three: 3, four: \n 4} \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
  ...
  SECTION(
      "YAML flow mapping allows a comment line between key and ':' value "
      "separator.",
  ...
  SECTION(
      "YAML parse nexted inline dictionary on more than line. "
      "(inline dictionary).",
      "[YAML][Parse][Dictionary]") {
    BufferSource source{
        "---\nouter: { one: \n1, \n two : 2\n, \n three: 3, "
    ...
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["outer"]).contains("three"));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)["outer"]).contains("four"));
    compareYAML(yaml, "---\nouter: \n  one: 1\n  two: 2\n  three: 3\n  four: 4\n...\n");
  }

  SECTION("YAML parse dictionary with  no key value.", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n: 'test'\n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    REQUIRE_FALSE(!NRef<Dictionary>(yaml.document(0)).contains(""));
  ...
  SECTION("YAML parse dictionary with no key value twice.", "[YAML][Parse][Dictionary]") {
  ...
  SECTION(
      "YAML parses explicit block mappings with complex keys and mixed "
      "value forms.",
    ...
    REQUIRE(NRef<String>(yaml.document(0)["complex5"]["[a]"][0]).value() == "b");
  }
  SECTION(
  ...
  SECTION("YAML parse dictionary with out of line key indentation.", "[YAML][Parse][Dictionary]") {
  ...
  SECTION("YAML parse in dictionary one key value pair and multipal trailing ','.",
          "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { one: 1,,,} \n...\n"};
  ...
  SECTION("YAML parse  dictionary with just keys (example 1).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee, } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\n...\n");
  }
  SECTION("YAML parse  dictionary with just keys (example 2).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee:, } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\n...\n");
  }
  SECTION("YAML parse  dictionary with just keys (example 3).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee:, rrrr } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\nrrrr: null\n...\n");
  }
  SECTION("YAML parse  dictionary with just keys (example 4).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee:, rrrr:, ooooo:, } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\nrrrr: null\nooooo: null\n...\n");
  }
  SECTION("YAML parse  dictionary with just keys (example 5).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee:, \nrrrr:, \nooooo:, } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\nrrrr: null\nooooo: null\n...\n");
  }
  SECTION("YAML parse  dictionary with just keys (example 6).", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n { eeee, rrrr: } \n...\n"};
    REQUIRE_NOTHROW(yaml.parse(source));
    REQUIRE_FALSE(!isA<Dictionary>(yaml.document(0)));
    compareYAML(yaml, "---\neeee: null\nrrrr: null\n...\n");
  ...
  SECTION(
      "YAML parse dictionary with nested dictionary with partial entry "
      "(example 9).",
      "[YAML][Parse][Dictionary]") {
  ...
  SECTION(
      "YAML parse inline dictionary containing incorrect bracket numbers "
      "(example 1).",
      "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\n test: { one: 1, two: 2}}\n..."};
    REQUIRE_THROWS_WITH(yaml.parse(source),
  ...
  SECTION(
      "YAML parse inline dictionary containing '[' at end. "
      "(example 3).",
      "[YAML][Parse][Array]") {
    BufferSource source{"---\n test: { one: 1, two: 2} [ \n..."};
    REQUIRE_THROWS_WITH(yaml.parse(source),
  ...
  SECTION("YAML parse dictionary with string keys.", "[YAML][Parse][Dictionary]") {
    BufferSource source{
  ...
  SECTION("YAML parse string with wit dictionary after.", "[YAML][Parse][Dictionary]") {
    BufferSource source{"---\ntest string 0\ntest1: 1\ntest2: 2\ntest3: 4\n"};
    REQUIRE_THROWS_WITH(yaml.parse(source),
