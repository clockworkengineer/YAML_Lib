...
class Bencode_Stringify final : public IStringify {
 ...
 private:
  ...
  static void addBencodeString(IDestination& destination, const std::string_view sv) {
  ...
  static void stringifyBoolean(const Node& yNode, IDestination& destination) {
    stringify_detail::addBooleanLiteral(destination, NRef<Boolean>(yNode).value(), "4:True",
                                        "5:False");
  }
