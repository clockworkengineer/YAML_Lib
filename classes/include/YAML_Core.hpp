 ...
 *
 * Include this header only if you need direct access to node types, containers, or low-level
 * interfaces. Most users should prefer YAML.hpp for the main API.
 *
 * This header pulls in all fundamental types, error macros, interfaces, and containers for advanced
 * YAML manipulation.
 *
 * @section Usage
 ...
 *
 * This header should be included to access all core YAML types, error macros, interfaces, and
 * containers. The include order is carefully managed to ensure all dependencies are satisfied for
 * public API use.
 */
