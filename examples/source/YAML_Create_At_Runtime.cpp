...
int main([[maybe_unused]] int argc, [[maybe_unused]] char **argv)
{
  try {
    ...
    // yaml["object2"] = { { "currency", "USD" }, { "array", yl::JNode{ 23.22, 33, 55, 99.99 } } };
    // yl::BufferDestination destination;
    // yaml.stringify(destination);
    // PLOG_INFO << destination.toString();
    // destination.clear();
    // // create YAML using an initializer list and nesting array/objects using JNode{}.
    // yl::YAML yaml2 = { { "pi", 3.141 },
    //   { "sad", true },
    //   { "first_name", "Niels" },
    //   { "nothing", nullptr },
    //   { "the_answer", yl::JNode{ { "everything", 42 } } },
    //   { "list", yl::JNode{ 1, 0, 2 } },
    //   { "object", yl::JNode{ { "currency", "USD" }, { "value", yl::JNode{ 23.22, 33, 55, 99.99 } } } } };
